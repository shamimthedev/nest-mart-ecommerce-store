        ...
        <>
            <section>
                ...
                <div className="max-w-[1341px] mx-auto">
                    <div className="my-[50px] flex justify-between items-end">
                        <div className="px-3 py-1">
                            <h3 className='font-bold text-greeny text-2xl leading-7 mb-[18px]'>How can help you?</h3>
                            <h1 className="font-bold text-5xl leading-[58px] max-w-[385px] mb-[31px]">Let us know how
                                we can help you</h1>
                            <p className='max-w-[405px] mb-6 text-justify font-lato text-[#7E7E7E] leading-6'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut
                                elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus
                                leo.</p>
                            <p className='max-w-[405px] text-justify font-lato text-[#7E7E7E] leading-6'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut
                                elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus
                                leo.</p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <div className="px-3 py-1">
                                <h3 className='font-bold text-xl leading-6 mb-[22px]'>04.General Inquiries</h3>
                                <p className='max-w-[405px] text-justify font-lato text-[#7E7E7E] leading-6'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut
                                    elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus
                                    leo.</p>
                            </div>
                ...
                {/* Map Part */}
                <div className="max-w-[1610px] mx-auto mb-[50px] rounded-[15px] overflow-hidden z-[-99]">
                    <OpenStreetMap />
                </div>

                <div className="max-w-[1341px] mx-auto mb-[60px] flex justify-between">
                    <div className="">
                ...
                <div className="max-w-[1341px] mx-auto mb-[60px]">
                    <div className="flex justify-between items-center">
                        <form action="#" className="w-[65%]">
                            ...
                            <div className="w-full mb-4 mt-[30px] flex justify-between">
                                <input className="w-[48%] h-16 p-4 border border-[#ECECEC] outline-none rounded-[10px] font-lato text-[#838383]" type="text" placeholder="First name" />
                                <input className="w-[48%] h-16 p-4 border border-[#ECECEC] outline-none rounded-[10px] font-lato text-[#838383]" type="email" placeholder="Your email" />
                            </div>
                            <div className="w-full mb-4 flex justify-between">
                                <input className="w-[48%] h-16 p-4 border border-[#ECECEC] outline-none rounded-[10px] font-lato text-[#838383]" type="number" placeholder="Your phone" />
                                <input className="w-[48%] h-16 p-4 border border-[#ECECEC] outline-none rounded-[10px] font-lato text-[#838383]" type="text" placeholder="Subject" />
                            </div>
