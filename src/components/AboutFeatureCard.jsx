...
const AboutFeatureCard = ({feature}) => {
   const {title, img} = feature
    return (
        <div className="w-[423px] rounded-[15px] border border-[#ECECEC] hover:border-green-100 hover:shadow-md transition-all grid place-items-center gap-y-[30px] px-[34px] py-[51px] leading-6 group">
